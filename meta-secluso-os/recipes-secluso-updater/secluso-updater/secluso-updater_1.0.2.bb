...
SUMMARY = "Recipe to build and install Secluso Updater"
...
SRCREV = "53158a207aba42698a97e9e100237fc14c3d6ead"
...
CARGO_SRC_DIR = "update/os-updater"

# The binary gets installed in /usr/bin/tuf-updater per https://github.com/meta-rust/meta-rust/blob/328334d9d31241d1d29eb754c5c102d5b0e002ab/classes/rust-bin.bbclass#L5
...
SYSTEMD_SERVICE:${PN} = "secluso_updater.service"
SRC_URI:append = " file://secluso_updater.service "
FILES:${PN} += "${systemd_unitdir}/system/secluso_updater.service"
RDEPENDS:${PN} += " systemd"
...
# inherit cargo has its own do_install that installs the tuf-updater binary into /usr/bin. thus, we append
do_install:append() {
...
# Generate new one: `bitbake -c update_crates secluso-updater` from project root
